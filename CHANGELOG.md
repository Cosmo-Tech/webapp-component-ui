...
- fix possible error in SimplePowerBIReportEmbed ([2d0f4c5](https://github.com/Cosmo-Tech/webapp-component-ui/commit/2d0f4c5))
- fix support of unicode characters in DefaultAvatar component ([0bf3aac](https://github.com/Cosmo-Tech/webapp-component-ui/commit/0bf3aac))
- fix Table hidden by errors panel ([85efaa2](https://github.com/Cosmo-Tech/webapp-component-ui/commit/85efaa2))

### Dependencies

- update @cosmotech/core dependency to v2.0.0
- update @mui/x-date-pickers to v7
