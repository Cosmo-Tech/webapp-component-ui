...
export const ScenarioManagerTreeList = (props) => {
  ...
  if (buildSearchInfo) {
    console.log('"buildSearchInfo" prop is deprecated in ScenarioManagerTreeList. Please consider removing this prop.');
  }
  ...
  const collapseAll = () => {
    const newValue = {};
    Object.keys(nodesExpandedChildren).forEach((nodeId) => {
